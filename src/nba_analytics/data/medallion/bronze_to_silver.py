...
def save_df_and_dict(df_filtered, dict_df):
    ...
    df_filtered_file_path = filename_grabber.get_data_file("silver", settings.DATA_FILE_NAME)
    ...
    dict_df_file_path = filename_grabber.get_data_file("silver", settings.DATA_FILE_NAME_JSON)
